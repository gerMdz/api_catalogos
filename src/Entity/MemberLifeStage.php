...
#[ORM\Entity(repositoryClass: MemberLifeStageRepository::class)]
#[ORM\Table(name: 'members_life_stages')]
class MemberLifeStage
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne]
    #[ORM\JoinColumn(name: 'life_stages_id', referencedColumnName: 'id')]
    ...
    public function setLifeStage(?LifeStage $lifeStage): self
    {
